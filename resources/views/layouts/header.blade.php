    ...
    <ul class="navbar-right d-flex list-inline float-right mb-0">
        ...
        <li class="dropdown notification-list d-none d-md-block">
            <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="/assets/images/flags/us_flag.jpg" class="mr-2" height="12" alt="" onerror="this.style.display='none'"/> English <span class="mdi mdi-chevron-down"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right language-switch">
                ...
                <a class="dropdown-item" href="#"><img src="/assets/images/flags/indonesia_flag.jpg" alt="" height="16" onerror="this.style.display='none'"/><span> Indonesia </span></a>
            </div>
        </li>
        ...
        <!-- full screen -->
        <li class="dropdown notification-list d-none d-md-block">
            <a class="nav-link waves-effect" href="#" id="btn-fullscreen" title="Full Screen">
